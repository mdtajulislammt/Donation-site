            ...
            <form>
                <div className="flex ">
                    ...
                    <div className="relative w-[300px] lg:w-[600px] mx-auto ">
                        <input onChange={(e)=>{setSearchBtn(e.target.value)}}  type="search" id="search-dropdown" className="block p-3 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-lg  border border-gray-300  dark:text-white " placeholder="Search here . . ." required />
